...
var appClientFiles = {
    ...
    "app_client/selection/selection.controller.js": fs.readFileSync("app_client/selection/selection.controller.js", "utf8"),
    ...
    "app_client/common/services/dataProvider.service.js": fs.readFileSync("app_client/common/services/dataProvider.service.js", "utf8"),
...
fs.writeFile('public/angular/berygood.min.js', uglified.code, function(err) {
    if(err) {
	console.log(err);
    } else {
	console.log('Script generated and saved: berygood.min.js');
    }
});
